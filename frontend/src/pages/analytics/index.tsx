      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
        <div className="max-w-7xl mx-auto px-4 py-10">
          ...
          <div className="mb-16 animate-in slide-in-from-top-8 fade-in duration-700">
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white p-12 lg:p-16 shadow-2xl group">
              ...
              <div className="relative z-10 text-center">
                <div className="flex items-center justify-center gap-2 mb-4">
                  ...
                  <Badge className="bg-yellow-400/90 text-yellow-900 border-yellow-500/30 px-4 py-1.5 text-sm font-bold">
                    {mockStats.currentLevel} LEVEL
                  </Badge>
                </div>

                <h1 className="text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                  학습 <span className="text-yellow-300">분석</span> 📊
                </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200 hover:shadow-lg transition-all hover:-translate-y-1 animate-in slide-in-from-bottom-4 fade-in duration-500 delay-200 fill-mode-backwards">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 hover:shadow-lg transition-all hover:-translate-y-1 animate-in slide-in-from-bottom-4 fade-in duration-500 delay-300 fill-mode-backwards">
              <CardContent className="pt-6">
                <div className="flex items-center justify-between">
                  <div>
          ...
          {/* 레벨 진행 상황 */}
          <Card className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 border-2 border-indigo-200 shadow-md animate-in slide-in-from-bottom-4 fade-in duration-500 delay-600 fill-mode-backwards">
            <CardContent className="pt-6">
              ...
              <Progress value={mockStats.nextLevelProgress} className="h-4 [\u0026>div]:transition-all [\u0026>div]:duration-1000" />
            </CardContent>
          </Card>
                      ...
                      <div key={idx} className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-sm font-semibold ${skill.trend === 'up' ? 'text-green-600' : 'text-red-600'
                              }`}>
                              {skill.change}
                            </span>
                          </div>
